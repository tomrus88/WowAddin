...
CDataStore& (__thiscall *CDataStore::fpPutInt8)(CDataStore *pData, char val) = (PutInt8Ptr)0x0047AFE0;
CDataStore& (__thiscall *CDataStore::fpPutInt16)(CDataStore *pData, short val) = (PutInt16Ptr)0x0047B040;
